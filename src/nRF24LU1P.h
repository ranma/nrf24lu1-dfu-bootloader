...
#define out0bc     __xreg(0xC7C5) // ref: nRF24LU1+ Product Spec, Section 7.3, Table 26
...
// XDATA buffers
uint8_t __xdata __at (0xC700) in0buf[64];
uint8_t __xdata __at (0xC6C0) out0buf[64];
uint8_t __xdata __at (0xC680) in1buf[64];
uint8_t __xdata __at (0xC640) out1buf[64];
uint8_t __xdata __at (0xC7E8) setupbuf[8];
