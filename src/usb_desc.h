...
enum descriptor_type_t
{
  ...
  ENDPOINT_DESCRIPTOR,
  DFU_FUNCTIONAL_DESCRIPTOR = 0x21,
};
...
enum string_descriptor_indexes_t
{
  ...
  STRING_DESCRIPTOR_FLASH,
  STRING_DESCRIPTOR_BOOT,
};
...
typedef struct {
  ...
  uint8_t  bmAttributes;
  uint8_t  bMaxPower;
  interface_descriptor_t interface_flash;
  interface_descriptor_t interface_boot;
  dfu_functional_descriptor_t dfu_descriptor;
...
extern __code const char* const device_strings[4];

extern __code const flash_region_t flash_regions[2];
